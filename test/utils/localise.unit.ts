...
describe("Test localise", () => {
    ...
    test("Test addLangToUrl with url without queries and uppercase lang set", () => {
        const URL = "test.test.url";
        const LANG = "LANG";
        const RESULT = URL + "?lang=" + LANG.toLowerCase();
        expect(addLangToUrl(URL, LANG)).toBe(RESULT);
    });
    test("Test addLangToUrl with url with queries and uppercase lang set",  () => {
        const URL = "test.test.url?foo=bar";
        const LANG = "LANG";
        const RESULT = URL + "&lang=" + LANG.toLowerCase();
        expect(addLangToUrl(URL, LANG)).toBe(RESULT);
    ...
    test("Test addEncodeURILangToUrl with url without queries and lang set",  () => {
        const URL = "test.test.url";
        const LANG = "lang";
        const RESULT = URL + "?lang=" + LANG;
        expect(addEncodeURILangToUrl(URL, LANG)).toBe(RESULT);
    });
    test("Test addEncodeURILangToUrl with url with queries and lang set",  () => {
        const URL = "test.test.url?foo=bar";
        const LANG = "lang";
        const RESULT = URL + encodeURIComponent("&lang=") + LANG;
        expect(addEncodeURILangToUrl(URL, LANG)).toBe(RESULT);
    });
    test("Test addEncodeURILangToUrl with url without queries and uppercase lang set",  () => {
        const URL = "test.test.url";
        const LANG = "LANG";
        const RESULT = URL + "?lang=" + LANG.toLowerCase();
        expect(addEncodeURILangToUrl(URL, LANG)).toBe(RESULT);
    });
    test("Test addEncodeURILangToUrl with url with queries and uppercase lang set",  () => {
        const URL = "test.test.url?foo=bar";
        const LANG = "LANG";
        const RESULT = URL + encodeURIComponent("&lang=") + LANG.toLowerCase();
        expect(addEncodeURILangToUrl(URL, LANG)).toBe(RESULT);
    });
    test("Test addEncodeURILangToUrl with url without queries and no lang set",  () => {
        const URL = "test.test.url";
